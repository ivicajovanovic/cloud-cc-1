...
**Section index short labels (in page order):** Start · Why now · What's new · Calendar · Distros · More distros · Compare · Finder · Desktops · Updates · Apps · Gaming · Hardware · Switch · Glossary · FAQ · Help
...
**Eyebrow:** Context
**Heading (h2):** Why so many people are trying Linux
...
**Eyebrow:** The big shifts
**Heading (h2):** Six changes that matter this year
**Intro:** You don't need to follow Linux news to benefit from these. Here's what each change means in practice.

### 4.1 Wayland is now the default
...
### 4.4 Image-based systems grew up
...
### 4.6 AI agents arrived on the desktop
...
**Eyebrow:** Timeline
**Heading (h2):** The 2026 release calendar
**Intro:** Drag the slider, or use the arrow keys, to move through the releases that shaped the year. Planned releases are marked.
...
**Heading (h2):** Six distros worth a close look
**Intro:** A distro (short for distribution) is a complete operating system built around the Linux kernel. These six cover most needs, from a first install to a developer workstation.

**Card labels (reused on every card):** Based on · Desktop · Updates · Support · Good for · Think twice if · What's new · Hardware
...
**Eyebrow:** Beyond the shortlist
**Heading (h2):** More distros, grouped by what you need
...
### Group: Power users and professionals
...
**Heading (h2):** Compare fourteen distros
**Intro:** Facts as of September 2026. Scroll sideways on small screens. Use the filters to narrow the list.

**Filter chips:** All · Beginner-friendly · Developers · Gaming · Servers
...
**Heading (h2):** Find your distro with three switches
**Intro:** There are no wrong answers, and you can always try a different distro later. Nothing you choose here is stored or sent anywhere.

**Question 1:** How much do you want to tinker?
...
|---|---|
| **Linux Mint** | Its desktop works the way Windows does, it avoids surprises, and it's supported for years. The easiest first step. *Also try: Zorin OS* |
| **Ubuntu 26.04 LTS** | A modern, well-supported desktop with five years of updates and more tutorials than any other distro. *Also try: elementary OS* |
| **Omarchy 4** | A finished keyboard-driven tiling desktop with developer tools and AI agents ready from the first boot. *Also try: Pop!_OS* |
| **Fedora 44** | The newest stable developer tools and desktop, tested before release and updated twice a year. *Also try: Ubuntu 26.04 LTS* |
| **Bazzite** | Steam, drivers and game launchers come ready, and any bad update can be undone at startup. *Also try: SteamOS (AMD graphics only)* |
| **CachyOS** | Built for speed, with optimized kernels and plenty of room to tune. *Also try: Bazzite* |
| **Debian 13** | Stable, predictable and supported until 2030. The foundation of much of the Linux world. *Also try: Ubuntu Server* |
| **Pop!_OS with COSMIC** | Windows tile automatically, but you can still work with the mouse, and there's no config file to write. *Also try: Fedora KDE* |
| **Arch Linux** | You choose every piece, and you learn how Linux works along the way. Keep the Arch Wiki open. *Also try: openSUSE Tumbleweed* |
| **NixOS 26.05** | Your whole system in one file: reproducible, reversible, and easy to share between machines. *Also try: Fedora Atomic* |
...
**Heading (h2):** The desktop is what you actually see
**Intro:** A distro and its desktop are two different things. The desktop environment is the interface: the panels, the windows, the menus and the settings. Most distros offer more than one. If you don't like how a distro looks, you might only need a different desktop, not a different distro.
...
**Eyebrow:** Update models
**Heading (h2):** Four ways a distro updates, and why it matters
**Intro:** How a distro delivers updates shapes your daily experience more than almost anything else. Pick the model that matches how much change you're comfortable with.
...
**Eyebrow:** Software
**Heading (h2):** Your apps on Linux
**Intro:** Most of what you do on a computer today happens in a browser, and every major browser runs on Linux. For everything else, here's how installing works and what to use instead of Windows-only software.

### 12A: How you install apps
...
**Eyebrow:** Gaming
**Heading (h2):** Gaming on Linux, honestly
**Intro:** Gaming on Linux has improved enormously, but it isn't perfect. Here's where it stands in 2026.
...
**Intro:** Almost certainly. Linux runs on everything from ten-year-old laptops to brand-new gaming PCs. Find your situation below.
...
**Heading (h2):** Switch to Linux in eight steps
**Intro:** Set aside an afternoon. You can stop after step 6 and change nothing on your computer.
...
8. **Your first week.**
   Install all updates. Accept any driver the system suggests. Turn on Flathub if your distro doesn't include it. Install your apps. Set up automatic backups with the built-in backup tool, Déjà Dup or Timeshift.
...
## 18. Get help, sources and footer (`#help`)

**Eyebrow:** Community
**Heading (h2):** You won't be on your own
**Intro:** Every major distro has an active community, and most questions have already been answered somewhere. These are good places to start.
...
**Secondary link:** Find your distro

---

## 20. Microcopy reference
